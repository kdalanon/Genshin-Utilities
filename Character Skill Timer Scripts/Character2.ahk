...
IniRead, SavedCharacterSlot2, Character Skill Timer Scripts\Config.ini, Characters, SavedCharacterSlot2
...
/*
====================================================
Initialize second party member as not the current
active character
====================================================
*/
...
{
	Gui, Show, AutoSize NA x1525 y355,,
}
return
...
Switch
{
	Case SkillTimer = 0:
		...
		Gui, Color, 0x00FF00 ; Lime
		SkillTimer := %SavedCharacterSlot2%
		SetTimer, Start, Off
	Case SkillTimer > 5:
...
{
	if (SavedCharacterSlot2 != "")
	{
		Switch SlowingWater
		{
			Case "SlowingWater=1": SkillTimer := Format("{:d}", (%SavedCharacterSlot2% / 100) * 250)
			Case "SlowingWater=0": SkillTimer := %SavedCharacterSlot2%
		}
