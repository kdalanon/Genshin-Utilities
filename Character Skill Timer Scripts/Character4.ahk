...
IniRead, SavedCharacterSlot4, Character Skill Timer Scripts\Config.ini, Characters, SavedCharacterSlot4
...
/*
====================================================
Initialize fourth party member as not the current
active character
====================================================
*/
...
{
	Gui, Show, AutoSize NA x1525 y545,,
}
return
...
Switch
{
	Case SkillTimer = 0:
		...
		Gui, Color, 0x00FF00 ; Lime
		SkillTimer := %SavedCharacterSlot4%
		SetTimer, Start, Off
	Case SkillTimer > 5:
...
{
	if (SavedCharacterSlot4 != "")
	{
		Switch SlowingWater
		{
			Case "SlowingWater=1": SkillTimer := Format("{:d}", (%SavedCharacterSlot4% / 100) * 250)
			Case "SlowingWater=0": SkillTimer := %SavedCharacterSlot4%
		}
